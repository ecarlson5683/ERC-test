...
knitr::include_graphics("photos/balloons_and_me.jpeg")
knitr::include_graphics("photos/balloons.jpeg")
```
...
```{r echo=FALSE, out.width="30%"}
knitr::include_graphics("photos/blue.jpeg")
```
...
```{r echo=FALSE, out.width="30%"}
knitr::include_graphics("photos/market.jpeg")
```
...
```{r echo=FALSE, out.width="30%"}
knitr::include_graphics("photos/tacos.jpeg")
```
